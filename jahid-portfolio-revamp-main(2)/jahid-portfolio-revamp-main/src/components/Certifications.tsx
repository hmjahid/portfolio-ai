  ...
  const renderCertificationCards = (certifications) => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {certifications.map((cert, index) => (
        <Card key={index} className="border border-gray-200 hover:border-portfolio-blue transition-colors animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
  ...
  return (
    <section id="certifications" className="section-padding bg-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <Tabs defaultValue="freecodecamp" className="w-full mt-12">
