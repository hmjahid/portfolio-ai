      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 mt-12 md:max-w-[80%] md:mx-auto lg:max-w-none">
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 flex-grow">
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-gray-800 p-4 md:p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 h-full"
          >
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <AnimatePresence mode="wait">
              {isSuccess ? (
                <motion.div
                  ...
                  className="bg-green-50 dark:bg-green-900/20 p-8 rounded-xl text-center border border-green-100 dark:border-green-800"
                >
                  <CheckCircle2 className="h-16 w-16 text-green-500 mx-auto mb-4" />
                  <h3 className="text-2xl font-semibold text-green-700 dark:text-green-400 mb-2">Message Sent!</h3>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="text-green-700 dark:text-green-400 border-green-200 dark:border-green-700 hover:bg-green-100 dark:hover:bg-green-800"
                  >
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <p className={cn(
                        "text-sm",
                        formData.message.length < 10 ? "text-gray-500 dark:text-gray-400" : "text-green-500"
                      )}>
